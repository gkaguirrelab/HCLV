...
switch sessNum
    case 1 %restAndStructure
        ...
        switch runNum
            ...
            case {1, 2, 3, 4, 6, 7, 8, 9, 10, 11, 12} % data collection
                recTime = runSecs{runNum};
                savePath = outDir;
                saveName = runNames{runNum};
    ...
    case 2 %spatial stimuli
        ...
        fprintf(['\nRun Names:\n' ...
            ...
            '\n17 - T1_axial (only if need to recollect)' ...
        ...
        switch runNum
            case {2, 3, 5, 6, 7, 9, 10, 12, 13, 14, 15, 16, 17} % data collection
                recTime = runSecs{runNum};
                savePath = outDir;
                saveName = runNames{runNum};
