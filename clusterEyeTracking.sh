...
EOF
	...
	touch $submitJobFile
	echo "qsub -l h_vmem=12.2G,s_vmem=12G -e /data/jag/TOME/LOGS -o /data/jag/TOME/LOGS /data/jag/TOME/$subjName/$clusterSessionDate/eyeTracking_scripts/"$subjName"_"$runName".sh" > $submitJobFile
