...
# make folders on the cluster
	...
	# copy stimulus files on the cluster (from dropbox)
	echo "Enter your remote address to copy files on dropbox (e.g. <you>  @170.xxx.xx.xx)"
	read remoteUser
	echo "Enter your remote Username to copy files on dropbox (e.g. you@ <170.xxx.xx.xx>)"
	read remoteIP
